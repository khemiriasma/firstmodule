		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "New app",
									"targetURL": "#firstappfirstmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firstappfirstmodule-display": {
								"semanticObject": "firstappfirstmodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firstapp.firstmodule",
									"url": sap.ui.require.toUrl("firstapp/firstmodule")
								}
							}
						}
					}
